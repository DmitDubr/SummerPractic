...
import com.volna.app.core.storage.PlatformAppPreferences
...
val volnaAppModule = module {
    ...
    single<AppPreferences> { PlatformAppPreferences }
    single<PushPermissionGateway> { PlatformPushPermissionGateway }
