...
func (h *BookingHandler) CreateBooking(w http.ResponseWriter, r *http.Request, params bookingsapi.CreateBookingParams) {
	...
	mapped, err := createBookingDTO(created)
	if err != nil {
...
func createBookingDTO(value booking.Booking) (createBookingResponse, error) {
	mapped, err := bookingDTO(value)
	if err != nil {
		return createBookingResponse{}, err
	}
	return createBookingResponse{
		Booking:        mapped,
		IsFirstBooking: value.IsFirstBooking,
		ReminderHours:  value.ReminderHours,
	}, nil
}
