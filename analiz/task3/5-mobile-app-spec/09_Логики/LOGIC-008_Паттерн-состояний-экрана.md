...
| [SCR-003](../../3-design-brief/screens/SCR-003-heat-filters.md) | `listMarshals` | Loading, Content, Error (inline в sheet) |
| [SCR-004](../../3-design-brief/screens/SCR-004-heat-detail.md) | `getSlot` | Loading, Content, Error, Refreshing |
...
| Экран | Текст | CTA |
| :-- | :-- | :-- |
| SCR-001 | «Пока нет доступных заездов» (FR-005) | — |
...
| 404 detail | «Заезд не найден» / «Запись не найдена» |
...
| Экран | Примечание |
| :-- | :-- |
| SCR-002, SCR-003 | Без собственного list reload; SCR-003 — loading `listMarshals` |
...
- Safe area для sticky CTA (SCR-004, SCR-005).
- Pull-to-refresh — нативный `UIRefreshControl` на SCR-001, SCR-008.
...
| AC-L-002 | **Дано** пустой `items`, дефолт фильтры, **Тогда** «Пока нет доступных заездов». |
